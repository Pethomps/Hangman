...
WrongGuess   .BLKW #1
;********************** Subroutine4: PrintLetterCount **********************
;  Description: This subroutines displays how many letter the word to guess has
;     
;  Register Usage:
;     R0 Used for TRAP
...
;********************** Subroutine5: DisplayGuessingWord **********************
;  Description: This subroutines displays string initialized to all underscores
;               and number of remaining guesses
;     
;  Register Usage:
;     R0 Used for TRAP
;     R1 holds ASCII val of letter count
...
; Calculate remaining guesses = 6-wrongGuess counter    
    LD R0, WrongGuess       
    LD R1, SIX
    NOT R0, R0
    ADD R0, R0, #1
    ADD R0, R1, R0  ; R0 = 6 - WrongGuess counter
...
PROMPT_GUESS    .STRINGZ "\nYou have "
PROMPT_GUESS2   .STRINGZ " oportunities to guess!\n"

;********************** Subroutine6: checkGuess *****************************
...
;TITLE2  .STRINGZ "| | | |  / \\  | \\ | |/ ___||  \\/  |  / \\  | \\ | |\n"
;TITLE3  .STRINGZ "| |_| | / _ \\ |  \\| | |  _ | |\\/| | / _ \\ |  \\| |\n"
;TITLE4  .STRINGZ "|  _  |/ ___ \\| |\\  | |_| || |  | |/ ___ \\| |\\  |\n"
;TITLE5  .STRINGZ "|_| |_/_/   \\_\\_| \\_|\\____||_|  |_/_/   \\_\\_| \\_|\n"
TITLE1    .STRINGZ "\n+=======================+\n"
TITLE2    .STRINGZ "|---- H A N G M A N ----|\n"
TITLE3    .STRINGZ "+=======================+\n"
